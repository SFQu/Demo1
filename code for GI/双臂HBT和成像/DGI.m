...
Dir1= 'J:\HBT\GI\20140324\0\1\';    %  文件夹路径
Dir2= 'J:\HBT\GI\20140324\0\2\';    %  文件夹路径
Num1 = 5000;  %  图片文件数
Num2 = 10000;
Num3 = 20000;
Num = 50000;
...
for I = 1 : Num    %  循环将NUM幅图像累加 
    ...
    Image001 = double(rgb2gray(imread([Dir1 FileName1],'jpeg')));
    Image002 = double(rgb2gray(imread([Dir2 FileName2],'jpeg')));
    ...
    ColG2 = ColG2 + Ima .* Image2;              %关联计算S*I2(x2)
    Col   = Col + Imb .* Image2;                %计算R*I2(x2)
     ...
     if I==Num1
         ...
         Image1Avep2 = Image1Sump2./Num1;  %  求得I2(x2)的平均图像
         Image1Avep22= Image1Sump22./Num1; %  求得R的平均图像
...
%          imwrite(ColG2nor1,'J:\HBT\GI\20140324\0\GI\Image5000.bmp','bmp');
     ...
     if I==Num2
         ...
         Image2Avep2 = Image2Sump2./Num2;  %  求得I2(x2)的平均图像
         Image2Avep22= Image2Sump22./Num2; %  求得R的平均图像
     ...
     if I==Num3
         ...
         Image3Avep2 = Image3Sump2./Num3;  %  求得I2(x2)的平均图像
         Image3Avep22= Image3Sump22./Num3; %  求得R的平均图像
...
ImageAvep2 = ImageSump2./Num;  %  求得I2(x2)的平均图像
ImageAvep22= ImageSump22./Num; %  求得R的平均图像
