...
for I = 1: num    %  循环将NUM幅图像累加 
         if I<10
     FileName1=['acA2000-165uc (21534555)_20170427_183928970_000',int2str(I), '.bmp'];%桶探测器测量值
    Im1 = imread([Dir1 FileName1],'bmp');
        end
    if (I>=10&&I<100)
     FileName1=['acA2000-165uc (21534555)_20170427_183928970_00',int2str(I), '.bmp'];%桶探测器测量值
    Im1 = imread([Dir1 FileName1],'bmp'); 
    end
    if (I>=100&&I<1000)
     FileName1=['acA2000-165uc (21534555)_20170427_183928970_0',int2str(I), '.bmp'];%桶探测器测量值
    Im1 = imread([Dir1 FileName1],'bmp');   
    end
    if(I>=1000)
     FileName1=['acA2000-165uc (21534555)_20170427_183928970_',int2str(I), '.bmp'];%桶探测器测量值
    Im1 = imread([Dir1 FileName1],'bmp');  
    end
